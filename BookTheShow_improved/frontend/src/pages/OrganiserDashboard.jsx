...
export default function OrganiserDashboard() {
  ...
  async function createEvent(e) {
    ...
    try {
      ...
      setNotice('Event created. Now schedule a show time for it below.');
      loadEvents();
    } catch (err) {
  ...
  return (
    <div className="max-w-5xl mx-auto px-5 py-12">
      ...
      <p className="text-paperDim mb-8">Create listings, schedule show times, track revenue.</p>
      ...
      <div className="grid md:grid-cols-2 gap-6 mb-10">
        ...
        <motion.form
          ...
          className="ticket-card bg-stage2 border border-white/10 p-6"
        >
          <h2 className="font-display text-2xl tracking-wide mb-4">Schedule a show time</h2>
          <Field label="Event">
            <select
              required
